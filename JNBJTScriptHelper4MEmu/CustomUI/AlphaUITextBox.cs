...
namespace JNBJTScriptHelper4MEmu.CustomUI
{
    [DefaultEvent("TextChanged")]
    [DefaultProperty("Text")]
    public sealed partial class AlphaUITextBox : UIPanel
    {
        private readonly AlphaBlendTextBox edit = new AlphaBlendTextBox();
        private readonly UIScrollBar bar = new UIScrollBar();

       
        public AlphaUITextBox()
        {
            InitializeComponent();
        ...
        [Browsable(true)]
        [Description("TextEditBackColor"), Category("SunnyUI")]
        [DefaultValue(typeof(Color), "235, 243, 255")]
        public Color TextEditBackColor
        {
            get => edit.BackColor;
            set => edit.BackColor = value;
        }


        [Browsable(true)]
        [Description("TextBackAlpha"), Category("SunnyUI")]
        [DefaultValue(10)]
        public int TextEditBackAlpha
        {
            get => edit.BackAlpha;
            set => edit.BackAlpha = value;
        }

        [Browsable(true)]
        [Description("BarFillColor"), Category("SunnyUI")]
        [DefaultValue(typeof(Color), "235, 243, 255")]
        public Color BarFillColor
        {
            get => bar.FillColor;
            set => bar.FillColor = value;
        }
        [Browsable(true)]
        [Description("BarForeColor"), Category("SunnyUI")]
        [DefaultValue(typeof(Color), "235, 243, 255")]
        public Color BarForeColor
        {
            get => bar.ForeColor;
            set => bar.ForeColor = value;
        }
        [Browsable(true)]
        [Description("PressColor"), Category("SunnyUI")]
        [DefaultValue(typeof(Color), "235, 243, 255")]
        public Color BarPressColor
        {
            get => bar.PressColor;
            set => bar.PressColor = value;
        }
        [Browsable(true)]
        [Description("BarHoverColor"), Category("SunnyUI")]
        [DefaultValue(typeof(Color), "235, 243, 255")]
        public Color BarHoverColor
        {
            get => bar.HoverColor;
            set => bar.HoverColor = value;
        }
        [Browsable(true)]
        [Description("Font"), Category("SunnyUI")]
